import{w as d,t as l}from"./main-thread-D5xenQ4T.js";var m=`// node_modules/comctx/core/dist/index.js
...
`,a,e,t;function r(){if(e===void 0){const n=new Blob([m],{type:"application/javascript"});t=URL.createObjectURL(n),a=new Worker(t,{type:"module"}),e=d(a)}return e}async function h(n,i,s,o,c){return r().convertGifToVideo(n,i,s,o,c)}async function f(n){return r().cancelOperations(n)}function g(){e&&(l(e),e=void 0,a=void 0),t&&(URL.revokeObjectURL(t),t=void 0)}export{f as cancelGifToVideoOperations,h as convertGifToVideo,g as terminateVideoConversionWorker};
